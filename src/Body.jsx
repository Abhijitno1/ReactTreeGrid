...
class Body extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        if (this.props !== nextProps) {
            ...
            this.state = { dataToDisplay: this.flattenArray(nextProps.data) }
        }
    }

    //static getDerivedStateFromProps(nextProps, prevState) {
    //    if (nextProps.data !== prevState.prevDataProp) {
    //        return {
    //            dataToDisplay: this.flattenArray(nextProps.data),
    //            prevDataProp: nextProps.data,
    //        };
    //    }
    //    return null;
    //}
